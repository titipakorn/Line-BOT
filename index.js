...
bot.on('message', async function(event) {
  let GreetingMsg = "Welcome to App"
  let question = ['Do you have a car?', 'What is your name? (e.g. Ms.Mari Ponboon)', 'What is your nick name? (e.g. Mike)', 'What is your student ID? (e.g. 5622771234)', 'carbrand', 'color', 'vehicle']
  let confirm = ['', 'Your name is', 'Your nick name is', 'Your student ID is', 'carbr', 'colo', 'vehi']
  try {
    var profile = await event.source.profile();
    var user = await test(profile);
  } catch (err) {
